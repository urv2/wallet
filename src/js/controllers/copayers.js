...
angular.module('copayApp.controllers').controller('copayersController',
  function($scope, $rootScope, $timeout, $log, $ionicModal, profileService, go, notification, platformInfo, gettext, gettextCatalog) {
    ...
    self.shareSecret = function(secret) {
      if (isCordova) {
        var message = gettextCatalog.getString('Join my urv2 wallet. Here is the invitation code: {{secret}} You can download urv2 for your phone or desktop at https://urv2.com.br', {
          secret: secret
        });
