...
sign-desktop:
	...
	gpg -u 1112CFA1 --output webkitbuilds/urv2-osx.dmg.sig --detach-sig webkitbuilds/urv2-osx.dmg
...
verify-desktop:
	...
	gpg --verify webkitbuilds/urv2-osx.dmg.sig webkitbuilds/urv2-osx.dmg
