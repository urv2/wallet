  ...
  function($scope, $rootScope, $timeout, $log, $modal, profileService, go, notification, isCordova, gettext, gettextCatalog, animationService) {
    ...
    self.shareSecret = function(secret) {
      if (isCordova) {
        ...
        var message = gettextCatalog.getString('Join my urv2 wallet. Here is the invitation code: {{secret}} You can download urv2 for your phone or desktop at https://urv2.com.br', {secret: secret});
        window.plugins.socialsharing.share(message, gettextCatalog.getString('Invitation to share a urv2 Wallet'), null, null);
      }
    };
